...
Public Class admin_settings
    ...
    Private Sub UpdatePassword(adminID As Integer)
        ...
        Try
            ...
            Dim verifyQuery As String = "SELECT COUNT(*) FROM [admin] WHERE adminID = @adminID AND password = @oldPassword"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ' Assuming you have the adminID from the context
        Dim adminID As Integer = AdminLogin.admin_id_now
