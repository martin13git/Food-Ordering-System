...
Public Class user_forgotpassword
    Private Sub user_forgotpassword_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub UpdateuserPassword(adminID As Integer)
        ...
        Try
            ...
            Dim query As String = "SELECT dob, password FROM [user] WHERE Id = @adminID"
